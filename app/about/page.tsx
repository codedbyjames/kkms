        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-5xl md:text-6xl font-serif font-black text-gray-900 mb-6">
              About <span className="text-cyan-600">CU KKMS</span>
            </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-serif font-black text-gray-900 mb-6">Tentang Kami</h2>
              <p className="text-lg text-gray-600 mb-6 font-sans leading-relaxed">
                KKMS sebagai Koperasi Credit Union, harus dipahami secara umum sebagai lembaga pemberdayaan yang memberikan pelayanan keuangan mikro yang ditumbuhkan dan dikembangkan dari, oleh, untuk anggota. Semangat ini harus terus digali dan dikembangkan supaya KKMS tidak terjebak dan jatuh pada praktek penghimpunan dan pengumpulan modal. Modal utama KKMS adalah kumpulan orang yang saling membangun kepercayaan satu sama lain demi terwujudnya kebaikan dan kesejahteraan bersama.
              </p>
              {/* <p className="text-lg text-gray-600 mb-6 font-sans leading-relaxed">
