    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-5xl md:text-6xl font-serif font-black text-gray-900 mb-6">
              Welcome to <span className="text-cyan-600">CU KKMS</span>
            </h1>
      ...
      <section id="about" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-serif font-black text-gray-900 mb-6">Siapa Kami</h2>
              <p className="text-lg text-gray-600 mb-6 font-sans leading-relaxed">
                Pelayanan unggul menjadi kunci sukses dalam proses kemajuan sebuah organisasi khususnya yang bergerak di jasa pelayanan publik. Hal ini juga berlaku di KSP CU Karsa Kencana Mitra Sejahtera. KKMS akan terus maju dan berkembang jika dapat mempertahankan sekaligus meningkatkan kualitas pelayanan kepada anggota. Kesadaran akan hal itulah yang akan menjadi fokus perhatian Pengurus, Pengawas, dan Pengelola (Manajemen) secara berkelanjutan. Pelayanan yang unggul bertujuan untuk menciptakan kepuasan anggota sebagai pemilik (member-owner) sekaligus pengguna jasa (user).
              </p>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-2xl font-serif font-black text-cyan-400 mb-4">CU KKMS</h3>
            ...
            <div>
              ...
              <div className="space-y-2 text-gray-400 font-sans">
                ...
                <p>📞 022-878 059 56</p>
                <p>📍 Ruko Kota Mas</p>
                <p>Jl. Kota Mas Raya No. 3, Kota Cimahi</p>
              </div>
            </div>
          </div>
