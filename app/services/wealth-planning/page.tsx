          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-5xl md:text-6xl font-serif font-black text-gray-900 mb-6">
                Produk <span className="text-amber-500">Pinjaman</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8 font-sans leading-relaxed">
                KKMS menawarkan berbagai produk tabungan dan pinjaman yang sesuai dengan tahap-tahap kehidupan para anggota. Produk-produk tersebut disediakan untuk membantu anggota sampai pada tujuan keuangan yang mereka impikan
              </p>
